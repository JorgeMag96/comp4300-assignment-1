...
5. Update ```CMAKE_TOOLCHAIN_FILE``` variable in CMakePresets.json with output from previous command (what's this variable for ? [find more information here](https://cmake.org/cmake/help/latest/variable/CMAKE_TOOLCHAIN_FILE.html))
